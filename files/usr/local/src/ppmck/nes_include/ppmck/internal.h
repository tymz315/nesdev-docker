...
sound_internal:
	...
	jmp	do_effect		; (doesn't need JSR and RTS, JMP will do)
...
freq_end:
	jmp	detune_write_sub	;jsr	detune_write_sub
	;rts
...
rest_set:
	...
	lda	register_high,x
	sta	$4000,y
	jmp	sound_data_address	;jsr	sound_data_address
	;rts
tri:
	lda	#$00
	sta	$4000,y
...
freq_direct_set:
	cmp	#$f6
	bne	y_command_set
	jmp	direct_freq_sub	;jsr	direct_freq_sub
	;rts
...
wait_set:
	cmp	#$f4
	bne	call_sub_command_set
	jmp	wait_sub	;jsr	wait_sub
	;rts

;----------
call_sub_command_set:
	cmp	#$ec
	bne	oto_set
	jsr	sound_data_address
	lda	[sound_add_low,x]
...
oto_set:
	...
	jmp	effect_init	;jsr	effect_init
	;rts

...
__VRC6	=	%00000001 ;reg $9000-9002,$A000-A002,$B000-$B002
__VRC7	=	%00000010 ;reg $9010,$9030
__FDS	=	%00000100 ;reg $4040-4092
__MMC5	=	%00001000 ;reg $5000-5015,($5205-5206),($5C00-5FF5)
__N106	=	%00010000 ;reg $4800,$F800
__FME7	=	%00100000 ;reg $C000,$F000
...
; INES header setup
	...
	.inesmap	0	; Mapper
	.if SOUND_GENERATOR
	.fail "Does not currently work iNES with expansion audio!!"
	.endif
	.endif

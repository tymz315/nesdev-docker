...
struct t_symbol  *bank_glabl[5][256];	/* latest global symbol for each bank */
...
int  opvaltab[7][16] = {
   ...
   {0x00, 0x00, 0x07, 0x17, 0x17, 0x03, 0x03, 0x13,  // unofficial opcodes
    0x0F, 0x1F, 0x1B, 0x00, 0x00, 0x00, 0x00, 0x00}
};

...
struct t_opcode base_pseudo[87] = {
	{NULL,  "=",       do_equ,     PSEUDO, P_EQU,     0},

	{NULL,  "ASSIGN",  do_assign,  PSEUDO, P_ASSIGN,  0},
...
{NULL, "ENDPROCGROUP", do_endp,    PSEUDO, P_ENDPG,   P_PGROUP},
	...
	{NULL,  "MACGOTO", do_macgoto, PSEUDO, P_MACGOTO, 0},
	{NULL,  "MACRO",   do_macro,   PSEUDO, P_MACRO,   0},
	{NULL,  "MACSET",  do_macset,  PSEUDO, P_MACSET,  0},

...
#define P_EMU		50	// .emu
#define P_ASSIGN	51	// .assign
#define P_MACGOTO	52	// .macgoto
#define P_MACSET	53	// .macset
#define P_NES2		54	// .nes2***
#define P_DATAFILE	55	// .datafile
...
#define COUNTED	7	/* label you access relative how many time it is defined */
